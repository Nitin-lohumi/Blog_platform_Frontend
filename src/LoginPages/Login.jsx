  ...
  const handleSubmit_Logindata = async (e) => {
    ...
    try {
      const url = await axios.post(
        "http://13.60.32.184:3000/auth/ManualLogin",
        LoginData,
    ...
    <>
      <div className="login_page">
        <LoginBox
          ...
          handleSubmit_Logindata={handleSubmit_Logindata}
          LoginData={LoginData}
        />
        {/* <a href={"http://localhost:3000/auth/google"} className="google_login"> 
         <i className="fa-brands fa-google"></i>
         <span>login with google</span></a> */}
        {/*  this will paid google auth does not support ip address use domian name instead but those are paid so let it  */}
      </div>
      <ToastContainer
        isLoading={false}
        autoClose={3000}
